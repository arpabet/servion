...
// enter servion/vrpc. The unreleased / sibling modules are resolved locally; on
// release, drop these replaces and pin tagged versions.
...
replace go.arpabet.com/obfs/xreality => ../../../../obfs/xreality
