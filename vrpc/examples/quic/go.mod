...
require (
	...
	go.arpabet.com/value-rpc/quic v1.4.2
)
...
// never enters servion/vrpc. servion/vrpc is resolved from this repo (the example
// tracks the in-repo code); external sibling modules are pinned to released versions.
