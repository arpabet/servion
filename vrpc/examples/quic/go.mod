module go.arpabet.com/servion/vrpc/examples/quic
...
require (
	...
	go.arpabet.com/value-rpc/quic v1.3.0
)
...
// This example is its OWN module so its QUIC dependency (github.com/quic-go/quic-go)
// never enters servion/vrpc. The unreleased / sibling modules are resolved locally;
// on release, drop these replaces and pin tagged versions.
...
replace go.arpabet.com/value-rpc/quic => ../../../../value-rpc/quic
